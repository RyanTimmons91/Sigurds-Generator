namespace StarSystemGeneratorV2
{
	partial class MainMenu
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "System Generator";
			...
			this.button2.Text = "NPC Encounter";
			...
			this.button3.Text = "Ship Generator";
			...
			this.button4.Text = "About / Changelog";
			this.button4.UseVisualStyleBackColor = true;
			// 
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(142, 99);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(113, 23);
			this.button5.TabIndex = 4;
			this.button5.Text = "Missile Launcher";
			this.button5.UseVisualStyleBackColor = true;
			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(142, 70);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(113, 23);
			this.button6.TabIndex = 5;
			this.button6.Text = "Mecha Generator";
			this.button6.UseVisualStyleBackColor = true;
			// 
			// button7
			// 
			this.button7.Location = new System.Drawing.Point(142, 41);
			this.button7.Name = "button7";
			this.button7.Size = new System.Drawing.Size(113, 23);
			this.button7.TabIndex = 6;
			this.button7.Text = "Handheld Weapons";
			this.button7.UseVisualStyleBackColor = true;
			// 
			// button8
			// 
			this.button8.Location = new System.Drawing.Point(142, 12);
			this.button8.Name = "button8";
			this.button8.Size = new System.Drawing.Size(113, 23);
			this.button8.TabIndex = 7;
			this.button8.Text = "Armor Generator";
			...
			this.button11.Text = "Resource Calculator";
			...
			this.button12.Text = "Dice Roller";
			this.button12.UseVisualStyleBackColor = true;
			// 
			// button13
			// 
			this.button13.Location = new System.Drawing.Point(142, 157);
			this.button13.Name = "button13";
			this.button13.Size = new System.Drawing.Size(113, 23);
			this.button13.TabIndex = 12;
			this.button13.Text = "Vehicle Weapons";
			this.button13.UseVisualStyleBackColor = true;
			// 
			// button14
			// 
			this.button14.Location = new System.Drawing.Point(142, 196);
			...
			this.button9.Text = "Base Value Mod.";
